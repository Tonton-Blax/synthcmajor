...
function create_fragment4(ctx) {
  ...
  let slider0_props = {
    ...
    min: ctx[12]?.attack?.annotation?.min,
    max: ctx[12]?.attack?.annotation?.max,
    step: ctx[12]?.attack?.annotation?.step
  };
  if (ctx[2] !== void 0) {
    slider0_props.value = ctx[2];
  }
  slider0 = new Slider_default({ props: slider0_props });
  ...
  let slider1_props = {
    orientation: "vertical",
    min: ctx[12]?.decay?.annotation?.min,
    max: ctx[12]?.decay?.annotation?.max,
    step: ctx[12]?.decay?.annotation?.step
  };
  if (ctx[3] !== void 0) {
    slider1_props.value = ctx[3];
  }
  slider1 = new Slider_default({ props: slider1_props });
  ...
  let slider2_props = {
    orientation: "vertical",
    min: ctx[12]?.sustain?.annotation?.min,
    max: ctx[12]?.sustain?.annotation?.max,
    step: ctx[12]?.sustain?.annotation?.step
  };
  if (ctx[5] !== void 0) {
    slider2_props.value = ctx[5];
  }
  slider2 = new Slider_default({ props: slider2_props });
  ...
  let slider3_props = {
    orientation: "vertical",
    min: ctx[12]?.release?.annotation?.min,
    max: ctx[12]?.release?.annotation?.max,
    step: ctx[12]?.release?.annotation?.step
  };
  if (ctx[4] !== void 0) {
    slider3_props.value = ctx[4];
  }
  slider3 = new Slider_default({ props: slider3_props });
  ...
  let knob0_props = {
    min: ctx[10]?.freq?.annotation?.min,
    max: ctx[10]?.freq?.annotation?.max,
    step: 10,
    strokeWidth: 10,
    primaryColor: "#E844C3"
  };
  ...
  let knob2_props = {
    min: ctx[10]?.volume?.annotation?.min,
    max: ctx[10]?.volume?.annotation?.max,
    step: ctx[10]?.volume?.annotation?.step,
    strokeWidth: 10,
    primaryColor: "#E844C3",
    valueDisplayFunction: func_1
  };
  if (ctx[6] !== void 0) {
    knob2_props.value = ctx[6];
  }
  knob2 = new src_default({ props: knob2_props });
  binding_callbacks.push(() => bind(knob2, "value", knob2_value_binding));
  function knob3_value_binding(value) {
    ctx[22](value);
  }
  let knob3_props = {
    min: ctx[11]?.freq?.annotation?.min,
    max: ctx[11]?.freq?.annotation?.max,
    step: 10,
    strokeWidth: 10,
    primaryColor: "#E844C3",
    valueDisplayFunction: func_2
  };
  if (ctx[1] !== void 0) {
  ...
  let knob4_props = {
    min: ctx[11]?.shape?.annotation?.min,
    max: ctx[11]?.shape?.annotation?.max,
    step: ctx[11]?.shape?.annotation?.step,
    strokeWidth: 10,
    primaryColor: "#E844C3",
    valueDisplayFunction: func_3
  };
  if (ctx[8] !== void 0) {
    knob4_props.value = ctx[8];
  }
  knob4 = new src_default({ props: knob4_props });
  binding_callbacks.push(() => bind(knob4, "value", knob4_value_binding));
  function knob5_value_binding(value) {
    ctx[24](value);
  }
  let knob5_props = {
    min: ctx[11]?.volume?.annotation?.min,
    max: ctx[11]?.volume?.annotation?.max,
    step: ctx[11]?.volume?.annotation?.step,
    strokeWidth: 10,
    primaryColor: "#E844C3",
    valueDisplayFunction: func_4
  };
  if (ctx[7] !== void 0) {
    knob5_props.value = ctx[7];
  }
  knob5 = new src_default({ props: knob5_props });
  ...
  return {
    ...
    h() {
      ...
      toggle_class(button7, "red", ctx[9]);
    ...
    m(target, anchor) {
      ...
      current = true;
      if (!mounted) {
        dispose = listen(button7, "click", ctx[25]);
        mounted = true;
      }
    },
    p(ctx2, [dirty]) {
      ...
      if (dirty & 4096)
        slider0_changes.min = ctx2[12]?.attack?.annotation?.min;
      if (dirty & 4096)
        slider0_changes.max = ctx2[12]?.attack?.annotation?.max;
      if (dirty & 4096)
        slider0_changes.step = ctx2[12]?.attack?.annotation?.step;
      if (!updating_value && dirty & 4) {
        updating_value = true;
        slider0_changes.value = ctx2[2];
        add_flush_callback(() => updating_value = false);
      }
      slider0.$set(slider0_changes);
      const slider1_changes = {};
      if (dirty & 4096)
        slider1_changes.min = ctx2[12]?.decay?.annotation?.min;
      if (dirty & 4096)
        slider1_changes.max = ctx2[12]?.decay?.annotation?.max;
      if (dirty & 4096)
        slider1_changes.step = ctx2[12]?.decay?.annotation?.step;
      if (!updating_value_1 && dirty & 8) {
        updating_value_1 = true;
        slider1_changes.value = ctx2[3];
        add_flush_callback(() => updating_value_1 = false);
      }
      slider1.$set(slider1_changes);
      const slider2_changes = {};
      if (dirty & 4096)
        slider2_changes.min = ctx2[12]?.sustain?.annotation?.min;
      if (dirty & 4096)
        slider2_changes.max = ctx2[12]?.sustain?.annotation?.max;
      if (dirty & 4096)
        slider2_changes.step = ctx2[12]?.sustain?.annotation?.step;
      if (!updating_value_2 && dirty & 32) {
        updating_value_2 = true;
        slider2_changes.value = ctx2[5];
        add_flush_callback(() => updating_value_2 = false);
      }
      slider2.$set(slider2_changes);
      const slider3_changes = {};
      if (dirty & 4096)
        slider3_changes.min = ctx2[12]?.release?.annotation?.min;
      if (dirty & 4096)
        slider3_changes.max = ctx2[12]?.release?.annotation?.max;
      if (dirty & 4096)
        slider3_changes.step = ctx2[12]?.release?.annotation?.step;
      if (!updating_value_3 && dirty & 16) {
        updating_value_3 = true;
        slider3_changes.value = ctx2[4];
        add_flush_callback(() => updating_value_3 = false);
      }
      slider3.$set(slider3_changes);
      const knob0_changes = {};
      if (dirty & 1024)
        knob0_changes.min = ctx2[10]?.freq?.annotation?.min;
      if (dirty & 1024)
        knob0_changes.max = ctx2[10]?.freq?.annotation?.max;
      ...
      const knob2_changes = {};
      if (dirty & 1024)
        knob2_changes.min = ctx2[10]?.volume?.annotation?.min;
      if (dirty & 1024)
        knob2_changes.max = ctx2[10]?.volume?.annotation?.max;
      if (dirty & 1024)
        knob2_changes.step = ctx2[10]?.volume?.annotation?.step;
      if (!updating_value_5 && dirty & 64) {
        updating_value_5 = true;
        knob2_changes.value = ctx2[6];
        add_flush_callback(() => updating_value_5 = false);
      }
      knob2.$set(knob2_changes);
      const knob3_changes = {};
      if (dirty & 2048)
        knob3_changes.min = ctx2[11]?.freq?.annotation?.min;
      if (dirty & 2048)
        knob3_changes.max = ctx2[11]?.freq?.annotation?.max;
      if (!updating_value_6 && dirty & 2) {
      ...
      const knob4_changes = {};
      if (dirty & 2048)
        knob4_changes.min = ctx2[11]?.shape?.annotation?.min;
      if (dirty & 2048)
        knob4_changes.max = ctx2[11]?.shape?.annotation?.max;
      if (dirty & 2048)
        knob4_changes.step = ctx2[11]?.shape?.annotation?.step;
      if (!updating_value_7 && dirty & 256) {
        updating_value_7 = true;
        knob4_changes.value = ctx2[8];
        add_flush_callback(() => updating_value_7 = false);
      }
      knob4.$set(knob4_changes);
      const knob5_changes = {};
      if (dirty & 2048)
        knob5_changes.min = ctx2[11]?.volume?.annotation?.min;
      if (dirty & 2048)
        knob5_changes.max = ctx2[11]?.volume?.annotation?.max;
      if (dirty & 2048)
        knob5_changes.step = ctx2[11]?.volume?.annotation?.step;
      if (!updating_value_8 && dirty & 128) {
        updating_value_8 = true;
        knob5_changes.value = ctx2[7];
        add_flush_callback(() => updating_value_8 = false);
      }
      knob5.$set(knob5_changes);
      if (!current || dirty & 512) {
        toggle_class(button7, "red", ctx2[9]);
      }
    },
    i(local) {
      if (current)
...
var func_1 = (v) => v.toFixed(2);
var func_2 = (v) => (v / 100).toFixed(2);
var func_3 = (v) => v.toFixed(2);
var func_4 = (v) => v.toFixed(2);
function instance4($$self, $$props, $$invalidate) {
  ...
  const setupInputs = (inputs2) => {
    if (!Array.isArray(inputs2))
      return;
    $$invalidate(10, osc1.freq = inputs2.find((i) => i.endpointID === "osc1FreqIn"), osc1);
    $$invalidate(0, osc1FreqIn = osc1.freq.annotation.init);
    $$invalidate(10, osc1.volume = inputs2.find((i) => i.endpointID === "osc1Volume"), osc1);
    $$invalidate(6, osc1Volume = osc1.volume.annotation.init);
    $$invalidate(11, osc2.volume = inputs2.find((i) => i.endpointID === "osc2Volume"), osc2);
    $$invalidate(7, osc2Volume = osc2.volume.annotation.init);
    $$invalidate(11, osc2.shape = inputs2.find((i) => i.endpointID === "osc2Shape"), osc2);
    $$invalidate(8, osc2Shape = osc2.shape.annotation.init);
    $$invalidate(11, osc2.freq = inputs2.find((i) => i.endpointID === "osc2FreqIn"), osc2);
    $$invalidate(1, osc2FreqIn = osc2.freq.annotation.init);
    $$invalidate(12, adsr1.attack = inputs2.find((i) => i.endpointID === "attack"), adsr1);
    $$invalidate(2, attack = adsr1.attack.annotation.init);
    $$invalidate(12, adsr1.decay = inputs2.find((i) => i.endpointID === "decay"), adsr1);
    $$invalidate(3, decay = adsr1.decay.annotation.init);
    $$invalidate(12, adsr1.sustain = inputs2.find((i) => i.endpointID === "sustain"), adsr1);
    $$invalidate(2, attack = adsr1.sustain.annotation.init);
    $$invalidate(5, sustain = adsr1.sustain.annotation.init);
    $$invalidate(12, adsr1.release = inputs2.find((i) => i.endpointID === "release"), adsr1);
    $$invalidate(4, release = adsr1.release.annotation.init);
  };
  function slider0_value_binding(value) {
    attack = value;
    $$invalidate(2, attack);
  ...
  function knob4_value_binding(value) {
    osc2Shape = value;
    $$invalidate(8, osc2Shape);
  }
  function knob5_value_binding(value) {
    osc2Volume = value;
    $$invalidate(7, osc2Volume);
  }
  const click_handler = (e) => $$invalidate(9, gateOn = !gateOn);
  $$self.$$set = ($$props2) => {
    if ("inputs" in $$props2)
      $$invalidate(14, inputs = $$props2.inputs);
  };
  $$self.$$.update = () => {
    if ($$self.$$.dirty & 16384) {
      $:
...
var Synth = class extends SvelteComponent {
  constructor(options) {
    super();
    init(this, options, instance4, create_fragment4, safe_not_equal, { inputs: 14 }, add_css4);
  }
  get inputs() {
    return this.$$.ctx[14];
  }
