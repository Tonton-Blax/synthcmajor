...
function create_fragment4(ctx) {
  ...
  let slider0_props = {
    ...
    min: ctx[8]?.attack?.annotation?.min,
    max: ctx[8]?.attack?.annotation?.max,
    step: 0.1
  };
  if (ctx[2] !== void 0) {
  ...
  let slider1_props = {
    orientation: "vertical",
    min: ctx[8]?.decay?.annotation?.min,
    max: ctx[8]?.decay?.annotation?.max,
    step: 0.1
  };
  if (ctx[3] !== void 0) {
  ...
  let slider3_props = {
    orientation: "vertical",
    min: ctx[8]?.release?.annotation?.min,
    max: ctx[8]?.release?.annotation?.max,
    step: 0.1
  };
  if (ctx[4] !== void 0) {
  ...
  let knob0_props = {
    min: ctx[6]?.freq?.annotation?.min,
    max: ctx[6]?.freq?.annotation?.max,
    step: 10,
    strokeWidth: 10,
    primaryColor: "#E844C3"
  };
  ...
  return {
    ...
    h() {
      ...
      toggle_class(button7, "red", ctx[5]);
    ...
    m(target, anchor) {
      ...
      current = true;
      if (!mounted) {
        dispose = listen(button7, "click", ctx[18]);
        mounted = true;
      }
    },
    p(ctx2, [dirty]) {
      ...
      if (dirty & 256)
        slider0_changes.min = ctx2[8]?.attack?.annotation?.min;
      if (dirty & 256)
        slider0_changes.max = ctx2[8]?.attack?.annotation?.max;
      ...
      if (dirty & 256)
        slider1_changes.min = ctx2[8]?.decay?.annotation?.min;
      if (dirty & 256)
        slider1_changes.max = ctx2[8]?.decay?.annotation?.max;
      ...
      if (dirty & 256)
        slider3_changes.min = ctx2[8]?.release?.annotation?.min;
      if (dirty & 256)
        slider3_changes.max = ctx2[8]?.release?.annotation?.max;
      ...
      const knob0_changes = {};
      if (dirty & 64)
        knob0_changes.min = ctx2[6]?.freq?.annotation?.min;
      if (dirty & 64)
        knob0_changes.max = ctx2[6]?.freq?.annotation?.max;
      ...
      const knob3_changes = {};
      if (dirty & 128)
        knob3_changes.min = ctx2[7]?.freq?.annotation?.min;
      if (dirty & 128)
        knob3_changes.max = ctx2[7]?.freq?.annotation?.max;
      ...
      if (!current || dirty & 32) {
        toggle_class(button7, "red", ctx2[5]);
      }
    },
    i(local) {
      if (current)
...
function instance4($$self, $$props, $$invalidate) {
  ...
  const setupInputs = (inputs2) => {
    if (!Array.isArray(inputs2))
      return;
    console.log(inputs2);
    $$invalidate(6, osc1.freq = inputs2.find((i) => i.endpointID === "osc1FreqIn"), osc1);
    $$invalidate(0, osc1FreqIn = osc1.freq.annotation.init);
    $$invalidate(7, osc2.freq = inputs2.find((i) => i.endpointID === "osc2FreqIn"), osc2);
    $$invalidate(1, osc2FreqIn = osc2.freq.annotation.init);
    $$invalidate(8, adsr1.attack = inputs2.find((i) => i.endpointID === "attack"), adsr1);
    $$invalidate(2, attack = adsr1.attack.annotation.init);
    $$invalidate(8, adsr1.decay = inputs2.find((i) => i.endpointID === "decay"), adsr1);
    $$invalidate(2, attack = adsr1.decay.annotation.init);
    $$invalidate(8, adsr1.release = inputs2.find((i) => i.endpointID === "release"), adsr1);
  ...
  const click_handler = (e) => $$invalidate(5, gateOn = !gateOn);
  $$self.$$set = ($$props2) => {
    if ("inputs" in $$props2)
      $$invalidate(10, inputs = $$props2.inputs);
  };
  $$self.$$.update = () => {
    if ($$self.$$.dirty & 1024) {
      $:
...
var Synth = class extends SvelteComponent {
  constructor(options) {
    super();
    init(this, options, instance4, create_fragment4, safe_not_equal, { inputs: 10 }, add_css4);
  }
  get inputs() {
    return this.$$.ctx[10];
  }
