...
function add_css4(target) {
  append_styles(target, "svelte-1019o8u", '@import url("https://unpkg.com/fluent-svelte/theme.css");.red.svelte-1019o8u.svelte-1019o8u{background-color:red}:root{--fds-control-strong-fill-default:gray}.flexline.svelte-1019o8u.svelte-1019o8u{display:flex;justify-content:space-evenly}.flexbox.svelte-1019o8u.svelte-1019o8u{display:flex;flex-direction:column;justify-content:flex-start;width:min-content;text-align:center}.flexbox.svelte-1019o8u>.svelte-1019o8u{width:auto;margin:5px auto}.container.svelte-1019o8u>.svelte-1019o8u{border:1px solid gray}.container.svelte-1019o8u.svelte-1019o8u{display:grid;grid-template-columns:200px 200px 200px 200px 200px 200px;grid-template-rows:200px 200px 150px 150px 150px;gap:0px 0px;grid-auto-flow:row;justify-content:center;align-content:center;justify-items:stretch;align-items:stretch;grid-template-areas:"osc1 osc1 branding branding adsr1 adsr1"\n      "osc2 osc2 vcf vcf adsr2 adsr2"\n      "sub noise hpf fine lfos voicing"\n      "reserved1 modMatrix modMatrix modMatrix modMatrix reverb"\n      "reserved2 modMatrix modMatrix modMatrix modMatrix delay"}.modMatrix.svelte-1019o8u.svelte-1019o8u{display:grid;grid-template-columns:1fr 1fr 1fr 1fr 1fr 1fr 1fr 1fr 1fr 1fr 1fr 1fr;grid-template-rows:1fr 1fr 1fr 1fr 1fr;gap:0px 0px;grid-auto-flow:row;justify-content:center;justify-items:stretch;align-items:stretch;grid-template-areas:". lfo1 lfo2 env1 env2 nw pb at math shape invert clip"\n      "_math . . . . . . . . . . ."\n      "_shape . . . . . . . . . . ."\n      "_invert . . . . . . . . . . ."\n      "_clip . . . . . . . . . . .";grid-area:modMatrix}.modMatrix.svelte-1019o8u>.svelte-1019o8u{border:1px dashed gray}.env1.svelte-1019o8u.svelte-1019o8u{grid-area:env1}.env2.svelte-1019o8u.svelte-1019o8u{grid-area:env2}._math.svelte-1019o8u.svelte-1019o8u{grid-area:_math}._shape.svelte-1019o8u.svelte-1019o8u{grid-area:_shape}._invert.svelte-1019o8u.svelte-1019o8u{grid-area:_invert}._clip.svelte-1019o8u.svelte-1019o8u{grid-area:_clip}.nw.svelte-1019o8u.svelte-1019o8u{grid-area:nw}.pb.svelte-1019o8u.svelte-1019o8u{grid-area:pb}.at.svelte-1019o8u.svelte-1019o8u{grid-area:at}.math.svelte-1019o8u.svelte-1019o8u{grid-area:math}.shape.svelte-1019o8u.svelte-1019o8u{grid-area:shape}.invert.svelte-1019o8u.svelte-1019o8u{grid-area:invert}.clip.svelte-1019o8u.svelte-1019o8u{grid-area:clip}.lfo1.svelte-1019o8u.svelte-1019o8u{grid-area:lfo1}.lfo2.svelte-1019o8u.svelte-1019o8u{grid-area:lfo2}.adsr1.svelte-1019o8u.svelte-1019o8u{grid-area:adsr1}.adsr2.svelte-1019o8u.svelte-1019o8u{grid-area:adsr2}.osc1.svelte-1019o8u.svelte-1019o8u{grid-area:osc1}.osc2.svelte-1019o8u.svelte-1019o8u{grid-area:osc2}.lfos.svelte-1019o8u.svelte-1019o8u{grid-area:lfos}.sub.svelte-1019o8u.svelte-1019o8u{grid-area:sub}.noise.svelte-1019o8u.svelte-1019o8u{grid-area:noise}.reverb.svelte-1019o8u.svelte-1019o8u{grid-area:reverb}.delay.svelte-1019o8u.svelte-1019o8u{grid-area:delay}.voicing.svelte-1019o8u.svelte-1019o8u{grid-area:voicing}.vcf.svelte-1019o8u.svelte-1019o8u{grid-area:vcf}.hpf.svelte-1019o8u.svelte-1019o8u{grid-area:hpf}.fine.svelte-1019o8u.svelte-1019o8u{grid-area:fine}.branding.svelte-1019o8u.svelte-1019o8u{grid-area:branding}.reserved1.svelte-1019o8u.svelte-1019o8u{grid-area:reserved1}.reserved2.svelte-1019o8u.svelte-1019o8u{grid-area:reserved2}button.svelte-1019o8u.svelte-1019o8u{font-size:12px;padding:4px}button.svelte-1019o8u.svelte-1019o8u:focus{background:tomato;color:white}button.pt.svelte-1019o8u.svelte-1019o8u{height:24px}');
}
function create_fragment4(ctx) {
  ...
  let knob0_props = {
    min: ctx[2]?.freq?.annotation?.min,
    max: ctx[2]?.freq?.annotation?.max,
    step: 10,
    strokeWidth: 10,
    primaryColor: "#E844C3"
  };
  ...
  return {
    ...
    l(nodes) {
      ...
      button7 = claim_element(div56_nodes, "BUTTON", { class: true });
      var button7_nodes = children(button7);
      t78 = claim_text(button7_nodes, "GATE");
    ...
    h() {
      attr(div0, "class", "env1 svelte-1019o8u");
      attr(div1, "class", "env2 svelte-1019o8u");
      attr(div2, "class", "_math svelte-1019o8u");
      attr(div3, "class", "_shape svelte-1019o8u");
      attr(div4, "class", "_invert svelte-1019o8u");
      attr(div5, "class", "_clip svelte-1019o8u");
      attr(div6, "class", "nw svelte-1019o8u");
      attr(div7, "class", "pb svelte-1019o8u");
      attr(div8, "class", "at svelte-1019o8u");
      attr(div9, "class", "math svelte-1019o8u");
      attr(div10, "class", "shape svelte-1019o8u");
      attr(div11, "class", "invert svelte-1019o8u");
      attr(div12, "class", "clip svelte-1019o8u");
      attr(div13, "class", "lfo1 svelte-1019o8u");
      attr(div14, "class", "lfo2 svelte-1019o8u");
      attr(div15, "class", "svelte-1019o8u");
      attr(div16, "class", "svelte-1019o8u");
      set_style(div17, "text-align", "center");
      set_style(div17, "margin", "auto");
      set_style(div17, "color", "red");
      set_style(div17, "font-size", "24px");
      attr(div17, "class", "svelte-1019o8u");
      attr(div18, "class", "modMatrix svelte-1019o8u");
      attr(div19, "class", "flexbox svelte-1019o8u");
      attr(div20, "class", "flexbox svelte-1019o8u");
      attr(div21, "class", "flexbox svelte-1019o8u");
      attr(div22, "class", "flexbox svelte-1019o8u");
      attr(button0, "class", "pt svelte-1019o8u");
      attr(button0, "state", "active");
      attr(button1, "class", "pt svelte-1019o8u");
      attr(button1, "state", "active");
      attr(div23, "class", "flexbox svelte-1019o8u");
      attr(div24, "class", "flexline svelte-1019o8u");
      set_style(div24, "height", "150px");
      attr(div25, "class", "adsr1 svelte-1019o8u");
      attr(div26, "class", "flexbox svelte-1019o8u");
      attr(div27, "class", "flexbox svelte-1019o8u");
      attr(div28, "class", "flexbox svelte-1019o8u");
      attr(div29, "class", "flexbox svelte-1019o8u");
      attr(button2, "class", "pt svelte-1019o8u");
      attr(button2, "state", "active");
      attr(button3, "class", "pt svelte-1019o8u");
      attr(button3, "state", "active");
      attr(div30, "class", "flexbox svelte-1019o8u");
      attr(div31, "class", "flexline svelte-1019o8u");
      set_style(div31, "height", "150px");
      attr(div32, "class", "adsr2 svelte-1019o8u");
      attr(div33, "class", "svelte-1019o8u");
      attr(div34, "class", "flexbox svelte-1019o8u");
      attr(div35, "class", "svelte-1019o8u");
      attr(div36, "class", "flexbox svelte-1019o8u");
      attr(div37, "class", "svelte-1019o8u");
      attr(div38, "class", "flexbox svelte-1019o8u");
      attr(div39, "class", "flexline svelte-1019o8u");
      attr(div40, "class", "osc1 svelte-1019o8u");
      attr(div41, "class", "svelte-1019o8u");
      attr(button4, "state", "active");
      attr(button4, "class", "svelte-1019o8u");
      attr(div42, "class", "flexbox svelte-1019o8u");
      attr(div43, "class", "svelte-1019o8u");
      attr(div44, "class", "flexbox svelte-1019o8u");
      attr(div45, "class", "svelte-1019o8u");
      attr(div46, "class", "flexbox svelte-1019o8u");
      attr(div47, "class", "flexline svelte-1019o8u");
      attr(div48, "class", "osc2 svelte-1019o8u");
      attr(div49, "class", "lfos svelte-1019o8u");
      attr(div50, "class", "svelte-1019o8u");
      attr(div51, "class", "flexbox svelte-1019o8u");
      attr(button5, "class", "pt svelte-1019o8u");
      attr(button6, "class", "pt svelte-1019o8u");
      attr(div52, "class", "flexbox svelte-1019o8u");
      attr(div53, "class", "flexline svelte-1019o8u");
      attr(div54, "class", "sub svelte-1019o8u");
      attr(div55, "class", "noise svelte-1019o8u");
      attr(button7, "class", "svelte-1019o8u");
      toggle_class(button7, "red", ctx[1]);
      attr(div56, "class", "reverb svelte-1019o8u");
      attr(div57, "class", "delay svelte-1019o8u");
      attr(div58, "class", "voicing svelte-1019o8u");
      attr(div59, "class", "vcf svelte-1019o8u");
      attr(div60, "class", "hpf svelte-1019o8u");
      attr(div61, "class", "fine svelte-1019o8u");
      attr(div62, "class", "branding svelte-1019o8u");
      attr(div63, "class", "reserved1 svelte-1019o8u");
      attr(div64, "class", "reserved2 svelte-1019o8u");
      attr(div65, "class", "container svelte-1019o8u");
    },
    m(target, anchor) {
      ...
      append_hydration(div56, button7);
      append_hydration(button7, t78);
      ...
      current = true;
      if (!mounted) {
        dispose = listen(button7, "click", ctx[8]);
        mounted = true;
      }
    },
    p(ctx2, [dirty]) {
      const knob0_changes = {};
      if (dirty & 4)
        knob0_changes.min = ctx2[2]?.freq?.annotation?.min;
      if (dirty & 4)
        knob0_changes.max = ctx2[2]?.freq?.annotation?.max;
      ...
      if (!current || dirty & 2) {
        toggle_class(button7, "red", ctx2[1]);
      }
    },
    i(local) {
      if (current)
...
function instance4($$self, $$props, $$invalidate) {
  ...
  const setupInputs = (inputs2) => {
    if (!Array.isArray(inputs2))
      return;
    console.log(inputs2);
    $$invalidate(2, osc1.freq = inputs2.find((i) => i.endpointID === "osc1Freq"), osc1);
    $$invalidate(0, osc1Freq = osc1.freq.annotation.init);
    console.log(osc1);
  };
  function knob0_value_binding(value) {
    osc1Freq = value;
    $$invalidate(0, osc1Freq);
  }
  const func = (v) => shape[v];
  const func_1 = (v) => shape[v];
  const click_handler = (e) => $$invalidate(1, gateOn = !gateOn);
  $$self.$$set = ($$props2) => {
    if ("inputs" in $$props2)
      $$invalidate(4, inputs = $$props2.inputs);
  };
  $$self.$$.update = () => {
    if ($$self.$$.dirty & 16) {
      $:
...
var Synth = class extends SvelteComponent {
  constructor(options) {
    super();
    init(this, options, instance4, create_fragment4, safe_not_equal, { inputs: 4 }, add_css4);
  }
  get inputs() {
    return this.$$.ctx[4];
  }
