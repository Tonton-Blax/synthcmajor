...
function create_fragment4(ctx) {
  ...
  let slider0_props = {
    ...
    min: ctx[9]?.attack?.annotation?.min,
    max: ctx[9]?.attack?.annotation?.max,
    step: ctx[9]?.sustain?.annotation?.step
  };
  if (ctx[2] !== void 0) {
  ...
  let slider1_props = {
    orientation: "vertical",
    min: ctx[9]?.decay?.annotation?.min,
    max: ctx[9]?.decay?.annotation?.max,
    step: ctx[9]?.sustain?.annotation?.step
  };
  if (ctx[3] !== void 0) {
  ...
  let slider2_props = {
    orientation: "vertical",
    min: ctx[9]?.sustain?.annotation?.min,
    max: ctx[9]?.sustain?.annotation?.max,
    step: ctx[9]?.sustain?.annotation?.step
  };
  if (ctx[5] !== void 0) {
  ...
  let slider3_props = {
    orientation: "vertical",
    min: ctx[9]?.release?.annotation?.min,
    max: ctx[9]?.release?.annotation?.max,
    step: ctx[9]?.sustain?.annotation?.step
  };
  if (ctx[4] !== void 0) {
  ...
  let knob0_props = {
    min: ctx[7]?.freq?.annotation?.min,
    max: ctx[7]?.freq?.annotation?.max,
    step: 10,
    strokeWidth: 10,
    primaryColor: "#E844C3"
  };
  ...
  let knob3_props = {
    min: ctx[8]?.freq?.annotation?.min,
    max: ctx[8]?.freq?.annotation?.max,
    step: 10,
    strokeWidth: 10,
    primaryColor: "#E844C3"
  };
  ...
  return {
    ...
    h() {
      ...
      toggle_class(button7, "red", ctx[6]);
    ...
    m(target, anchor) {
      ...
      current = true;
      if (!mounted) {
        dispose = listen(button7, "click", ctx[20]);
        mounted = true;
      }
    },
    p(ctx2, [dirty]) {
      ...
      if (dirty & 512)
        slider0_changes.min = ctx2[9]?.attack?.annotation?.min;
      if (dirty & 512)
        slider0_changes.max = ctx2[9]?.attack?.annotation?.max;
      if (dirty & 512)
        slider0_changes.step = ctx2[9]?.sustain?.annotation?.step;
      ...
      if (dirty & 512)
        slider1_changes.min = ctx2[9]?.decay?.annotation?.min;
      if (dirty & 512)
        slider1_changes.max = ctx2[9]?.decay?.annotation?.max;
      if (dirty & 512)
        slider1_changes.step = ctx2[9]?.sustain?.annotation?.step;
      ...
      if (dirty & 512)
        slider2_changes.min = ctx2[9]?.sustain?.annotation?.min;
      if (dirty & 512)
        slider2_changes.max = ctx2[9]?.sustain?.annotation?.max;
      if (dirty & 512)
        slider2_changes.step = ctx2[9]?.sustain?.annotation?.step;
      ...
      if (dirty & 512)
        slider3_changes.min = ctx2[9]?.release?.annotation?.min;
      if (dirty & 512)
        slider3_changes.max = ctx2[9]?.release?.annotation?.max;
      if (dirty & 512)
        slider3_changes.step = ctx2[9]?.sustain?.annotation?.step;
      ...
      const knob0_changes = {};
      if (dirty & 128)
        knob0_changes.min = ctx2[7]?.freq?.annotation?.min;
      if (dirty & 128)
        knob0_changes.max = ctx2[7]?.freq?.annotation?.max;
      ...
      const knob3_changes = {};
      if (dirty & 256)
        knob3_changes.min = ctx2[8]?.freq?.annotation?.min;
      if (dirty & 256)
        knob3_changes.max = ctx2[8]?.freq?.annotation?.max;
      ...
      if (!current || dirty & 64) {
        toggle_class(button7, "red", ctx2[6]);
      }
    },
    i(local) {
      if (current)
...
function instance4($$self, $$props, $$invalidate) {
  ...
  const setupInputs = (inputs2) => {
    if (!Array.isArray(inputs2))
      return;
    console.log(inputs2);
    $$invalidate(7, osc1.freq = inputs2.find((i) => i.endpointID === "osc1FreqIn"), osc1);
    $$invalidate(0, osc1FreqIn = osc1.freq.annotation.init);
    $$invalidate(8, osc2.freq = inputs2.find((i) => i.endpointID === "osc2FreqIn"), osc2);
    $$invalidate(1, osc2FreqIn = osc2.freq.annotation.init);
    $$invalidate(9, adsr1.attack = inputs2.find((i) => i.endpointID === "attack"), adsr1);
    $$invalidate(2, attack = adsr1.attack.annotation.init);
    $$invalidate(9, adsr1.decay = inputs2.find((i) => i.endpointID === "decay"), adsr1);
    $$invalidate(2, attack = adsr1.decay.annotation.init);
    $$invalidate(9, adsr1.sustain = inputs2.find((i) => i.endpointID === "sustain"), adsr1);
    $$invalidate(2, attack = adsr1.sustain.annotation.init);
    $$invalidate(9, adsr1.release = inputs2.find((i) => i.endpointID === "release"), adsr1);
  ...
  const click_handler = (e) => $$invalidate(6, gateOn = !gateOn);
  $$self.$$set = ($$props2) => {
    if ("inputs" in $$props2)
      $$invalidate(11, inputs = $$props2.inputs);
  };
  $$self.$$.update = () => {
    if ($$self.$$.dirty & 2048) {
      $:
...
var Synth = class extends SvelteComponent {
  constructor(options) {
    super();
    init(this, options, instance4, create_fragment4, safe_not_equal, { inputs: 11 }, add_css4);
  }
  get inputs() {
    return this.$$.ctx[11];
  }
